...
public class ExampleQuizPlayWithTopic3 extends AppCompatActivity {
    Dialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_example_quiz_play_with_topic3);
        ...
        dialog = new Dialog(ExampleQuizPlayWithTopic3.this);
        ...
        btn_dialogLuuThoat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(ExampleQuizPlayWithTopic3.this, MainScreen.class);
                startActivity(it);
                finish();
                Toast.makeText(ExampleQuizPlayWithTopic3.this,"Đã luu thành công ",Toast.LENGTH_LONG).show();
                dialog.dismiss();
            }
        });
        ...
        btnLuiLai.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(ExampleQuizPlayWithTopic3.this, ExampleQuizPlayWithTopic2.class);
                startActivity(it);
        ...
        btnTiepTuc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(ExampleQuizPlayWithTopic3.this, ExampleQuizPlayWithTopic4.class);
                startActivity(it);

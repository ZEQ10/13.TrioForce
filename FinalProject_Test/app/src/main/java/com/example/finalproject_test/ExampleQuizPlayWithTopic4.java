...
public class ExampleQuizPlayWithTopic4 extends AppCompatActivity {
    Dialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_example_quiz_play_with_topic4);
        ...
        dialog = new Dialog(ExampleQuizPlayWithTopic4.this);
        ...
        btn_dialogLuuThoat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(ExampleQuizPlayWithTopic4.this, MainScreen.class);
                startActivity(it);
                finish();
                Toast.makeText(ExampleQuizPlayWithTopic4.this,"Đã luu thành công ",Toast.LENGTH_LONG).show();
                dialog.dismiss();
            }
        });
        ...
        btnLuiLai.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(ExampleQuizPlayWithTopic4.this, ExampleQuizPlayWithTopic3.class);
                startActivity(it);
        ...
        btnTiepTuc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(ExampleQuizPlayWithTopic4.this, ExampleQuizPlayWithTopic5.class);
                startActivity(it);

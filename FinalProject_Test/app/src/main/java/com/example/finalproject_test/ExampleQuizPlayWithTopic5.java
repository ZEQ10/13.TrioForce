...
public class ExampleQuizPlayWithTopic5 extends AppCompatActivity {
    Dialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_example_quiz_play_with_topic5);
        ...
        dialog = new Dialog(ExampleQuizPlayWithTopic5.this);
        ...
        btn_dialogLuuThoat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(ExampleQuizPlayWithTopic5.this, MainScreen.class);
                startActivity(it);
                finish();
                Toast.makeText(ExampleQuizPlayWithTopic5.this,"Đã luu thành công ",Toast.LENGTH_LONG).show();
                dialog.dismiss();
            }
        });
        ...
        btnLuiLai.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(ExampleQuizPlayWithTopic5.this, ExampleQuizPlayWithTopic4.class);
                startActivity(it);
        ...
        btnTiepTuc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(ExampleQuizPlayWithTopic5.this, ExampleQuizPlayWithTopic6.class);
                startActivity(it);

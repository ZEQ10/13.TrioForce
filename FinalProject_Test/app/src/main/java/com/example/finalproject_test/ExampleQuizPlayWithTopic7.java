...
public class ExampleQuizPlayWithTopic7 extends AppCompatActivity {
    Dialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_example_quiz_play_with_topic7);
        ...
        dialog = new Dialog(ExampleQuizPlayWithTopic7.this);
        ...
        btn_dialogLuuThoat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(ExampleQuizPlayWithTopic7.this, MainScreen.class);
                startActivity(it);
                finish();
                Toast.makeText(ExampleQuizPlayWithTopic7.this,"Đã luu thành công ",Toast.LENGTH_LONG).show();
                dialog.dismiss();
            }
        });
        ...
        btnLuiLai.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(ExampleQuizPlayWithTopic7.this, ExampleQuizPlayWithTopic6.class);
                startActivity(it);
        ...
        btnTiepTuc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(ExampleQuizPlayWithTopic7.this, ExampleQuizPlayWithTopic8.class);
                startActivity(it);
